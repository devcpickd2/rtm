...
<div class="container-fluid py-0">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            {{-- Filter dan Search --}}
            <form method="GET" action="{{ route('steamer.index') }}" class="row g-2 mb-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex gap-2">
                    ...
                    <a href="{{ route('steamer.index') }}" class="btn btn-secondary w-100">
            ...
            <div class="mt-4 p-3 border rounded bg-light">
                <h5 class="mb-3"><i class="bi bi-file-earmark-pdf"></i> Export Data Pemeriksaan Pemasakan dengan Steamer ke PDF</h5>
                <form action="{{ route('steamer.exportPdf') }}" method="GET" target="_blank" class="row g-3 align-items-end">
                    <div class="col-md-4">
