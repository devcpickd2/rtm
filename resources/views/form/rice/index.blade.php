    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <div class="mt-4 p-3 border rounded bg-light">
                <h5 class="mb-3"><i class="bi bi-file-earmark-pdf"></i> Export Data Pemeriksaan Pemasakan dengan Rice Cooker ke PDF</h5>
                <form action="{{ route('rice.exportPdf') }}" method="GET" target="_blank" class="row g-3 align-items-end">
                    <div class="col-md-4">
