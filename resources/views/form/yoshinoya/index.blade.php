...
<div class="container-fluid py-0">
    ...
    <div class="card shadow-sm">
        ...
        <div class="mt-4 p-3 border rounded bg-light">
            <h5 class="mb-3"><i class="bi bi-file-earmark-pdf"></i> Export Data Parameter Produk Saus Yoshinoya ke PDF</h5>
            <form action="{{ route('yoshinoya.exportPdf') }}" method="GET" target="_blank" class="row g-3 align-items-end">
                <div class="col-md-4">
