...
<div class="container-fluid py-0">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            {{-- Filter dan Search --}}
            <form method="GET" action="{{ route('retur.index') }}" class="row g-2 mb-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    value="{{ request('search') }}" placeholder="Cari retur/kode produksi...">
                </div>
                <div class="col-md-3 d-flex gap-2">
                    <button type="submit" class="btn btn-primary w-100">
                        <i class="bi bi-funnel"></i> Filter
                    </button>
                    <a href="{{ route('retur.index') }}" class="btn btn-secondary w-100">
