...
<div class="container-fluid py-0">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            {{-- Filter dan Search --}}
            <label><strong>Cari data dari Rentang Tanggal...</strong></label>
            <form method="GET" action="{{ route('verifikasi_sanitasi.index') }}" class="row g-2 mb-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex gap-2">
                    ...
                    <a href="{{ route('verifikasi_sanitasi.index') }}" class="btn btn-secondary w-100">
