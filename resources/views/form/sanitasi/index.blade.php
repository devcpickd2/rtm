...
<div class="container-fluid py-0">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            {{-- Filter dan Search --}}
            <form method="GET" action="{{ route('sanitasi.index') }}" class="row g-2 mb-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex gap-2">
                    ...
                    <a href="{{ route('sanitasi.index') }}" class="btn btn-secondary w-100">
                ...
                <table class="table table-striped table-bordered align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $dep->std_footbasin }}</td>
                            <td>
                                @if($dep->aktual_footbasin)
                                <img src="{{ asset('storage/' . $dep->aktual_footbasin) }}" alt="Foot Basin" style="max-width:100px; height:auto;">
                                @else
                                -
                                @endif
                            </td>

                            <td>{{ $dep->std_handbasin }}</td>
                            <td>
                                @if($dep->aktual_handbasin)
                                <img src="{{ asset('storage/' . $dep->aktual_handbasin) }}" alt="Hand Basin" style="max-width:100px; height:auto;">
                                @else
                                -
                                @endif
                            </td>
