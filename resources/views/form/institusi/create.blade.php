                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="jenis_produk" name="jenis_produk" class="form-control">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="time" id="waktu_proses_selesai" name="waktu_proses_selesai" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6">
