...
<div class="container-fluid py-4">
    <div class="card shadow-sm">
        <div class="card-body"> 
            <h4><i class="bi bi-plus-circle"></i> Form Input Pemusnahan Barang / Produk</h4>
            <form method="POST" action="{{ route('pemusnahan.store') }}" enctype="multipart/form-data">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <textarea name="analisis" class="form-control" placeholder="Tuliskan Analisis Masalah"></textarea>
                    </div>
                    <div class="card-header bg-light">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Jika data lama kosong, set default tanggal hari ini
        if(!dateInput.value){
            let now = new Date();
