                    ...
                    <table class="table table-bordered table-sm text-center align-middle" id="pemeriksaanTable">
                        ...
                        <tbody class="pemeriksaan">
                            ...
                            <tr>
                                ...
                                <td><div class="form-check text-center m-0"><input type="checkbox" name="pemeriksaan[{{ $index }}][fe]" class="form-check-input" value="Oke" {{ old("pemeriksaan.$index.fe", $row['fe']) == 'Oke' ? 'checked' : '' }}></div></td>
                                <td><div class="form-check text-center m-0"><input type="checkbox" name="pemeriksaan[{{ $index }}][non_fe]" class="form-check-input" value="Oke" {{ old("pemeriksaan.$index.non_fe", $row['non_fe']) == 'Oke' ? 'checked' : '' }}></div></td>
                                <td><div class="form-check text-center m-0"><input type="checkbox" name="pemeriksaan[{{ $index }}][sus_316]" class="form-check-input" value="Oke" {{ old("pemeriksaan.$index.sus_316", $row['sus_316']) == 'Oke' ? 'checked' : '' }}></div></td>
                                <td>
                                    @php
                                    $keterangan = $row['keterangan'] ?? '';
                                    @endphp
                                    <select name="pemeriksaan[{{ $index }}][keterangan]" 
                                    class="form-control form-control-sm" required>
                                    <option value="Terdeteksi" {{ old("pemeriksaan.$index.keterangan", $keterangan) == 'Terdeteksi' ? 'selected' : '' }}>Terdeteksi</option>
                                    <option value="Tidak Terdeteksi" {{ old("pemeriksaan.$index.keterangan", $keterangan) == 'Tidak Terdeteksi' ? 'selected' : '' }}>Tidak Terdeteksi</option></select>
                                </td>
