    ...
    <div class="card shadow-sm">
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @php
                                $thumbling = json_decode($dep->thumbling, true);
                                @endphp

                                @if(!empty($thumbling))
                                <a href="#" data-bs-toggle="modal" data-bs-target="#thumblingModal{{ $dep->uuid }}" style="font-weight: bold; text-decoration: underline;">
                                    Hasil thumbling
                                </a>
                                <div class="modal fade" id="thumblingModal{{ $dep->uuid }}" tabindex="-1" aria-labelledby="thumblingModalLabel{{ $dep->uuid }}" aria-hidden="true">
                                    <div class="modal-dialog" style="max-width: 500px;">
                                        <div class="modal-content">
                                            <div class="modal-header bg-info text-white">
                                                <h5 class="modal-title text-start" id="thumblingModalLabel{{ $dep->uuid }}">Detail thumbling</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <ul class="list-group text-left">
                                                    @foreach($thumbling as $index => $item)
            ...
            <div class="mt-4 p-3 border rounded bg-light">
                <h5 class="mb-3"><i class="bi bi-file-earmark-pdf"></i> Export Data Pemeriksaan Proses Thumbling ke PDF</h5>
                <form action="{{ route('thumbling.exportPdf') }}" method="GET" target="_blank" class="row g-3 align-items-end">
                    <div class="col-md-4">
